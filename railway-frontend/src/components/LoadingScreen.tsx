export default function LoadingScreen() {
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div className="absolute -top-24 -left-24 w-72 h-72 rounded-full bg-purple-500/20 blur-3xl animate-blob" />
      <div className="absolute -bottom-24 -right-24 w-72 h-72 rounded-full bg-blue-500/20 blur-3xl animate-blob animation-delay-2000" />
      <div className="absolute top-1/3 right-1/4 w-72 h-72 rounded-full bg-emerald-500/10 blur-3xl animate-blob animation-delay-4000" />
