  ...
  return (
    <>
      ...
      >
        ...
        {/* Close button */}
        <div className="flex justify-between w-full relative z-10 p-6">
          <button
            onClick={handleClose}
            className={cn(
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-10">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            {transcript && (
              <p className={cn(
                "text-sm max-w-md text-center mt-4",
                isDark ? "text-white/60" : "text-black/60"
              )}>
                You: {transcript}
              </p>
            ...
            {response && (
              <p className={cn(
                "text-sm max-w-md text-center mt-2",
                isDark ? "text-white/60" : "text-black/60"
              )}>
                Assistant: {response}
              </p>
        ...
        {/* Control buttons */}
        <div className="flex justify-center gap-4 relative z-10 p-6">
          <button
