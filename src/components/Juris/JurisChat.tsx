...
export default function JurisChat({
    ...
    return (
        <>
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/98 to-transparent pt-4 pb-6 border-t border-white/5">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                                {SAMPLE_CASES.map((sample, idx) => (
                                    <button
                                        ...
                                        className="px-4 py-2 bg-white/5 hover:bg-purple-500/10 border border-white/10 hover:border-purple-500/30 rounded-xl text-xs text-white/70 hover:text-purple-300 transition-all duration-300 backdrop-blur-sm group"
                                    >
                    ...
                    <form onSubmit={handleSubmit} className="relative">
                        <div className="flex gap-0 items-center bg-white/5 border border-white/10 rounded-2xl hover:border-white/20 transition-all backdrop-blur-sm overflow-hidden">
                            <input
                                type="text"
                                name="message"
                                placeholder={config.placeholder}
                                className="flex-1 px-6 py-4 text-base bg-transparent text-white placeholder-white/40 focus:outline-none"
                                autoComplete="off"
                            />
                            ...
                            <div className="flex items-center gap-2 pr-3">
                                <div className="p-1 rounded-xl bg-white/5 border border-white/10 inline-flex">
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 flex items-center gap-1.5 ${mode === 'normal'
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 flex items-center gap-1.5 ${mode === 'deep_research'
                                ...
                                <button
                                    type="submit"
                                    className="p-2.5 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/30 hover:border-purple-500/50 rounded-xl text-purple-300 hover:text-purple-200 transition-all duration-300"
                                >
