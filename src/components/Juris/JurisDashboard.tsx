...
export default function JurisDashboard({ metrics, onRefresh }: JurisDashboardProps) {
    return (
        <div className="space-y-6 pb-24">
            ...
            <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="p-6 bg-gradient-to-br from-purple-900/20 to-violet-900/20 border border-purple-500/20 rounded-2xl backdrop-blur-sm">
                    ...
                    <p className="text-3xl font-bold text-purple-300">{(metrics.precisionAt5 * 100).toFixed(0)}%</p>
                    <p className="text-xs text-white/40 mt-2">Industry leading accuracy</p>
                </div>
                ...
                <div className="p-6 bg-gradient-to-br from-violet-900/20 to-purple-900/20 border border-violet-500/20 rounded-2xl backdrop-blur-sm">
                    ...
                    <p className="text-3xl font-bold text-violet-300">{metrics.avgResponseTime.toFixed(1)}s</p>
                    <p className="text-xs text-white/40 mt-2">Real-time search performance</p>
                </div>
                ...
                <div className="p-6 bg-gradient-to-br from-indigo-900/20 to-purple-900/20 border border-indigo-500/20 rounded-2xl backdrop-blur-sm">
                    ...
                    <p className="text-3xl font-bold text-indigo-300">{metrics.totalCases.toLocaleString()}</p>
                ...
                <div className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${metrics.vectorStoreStatus === 'Active'
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${metrics.graphDbStatus === 'Active'
                                    ? 'bg-green-500/20 border border-green-500/30 text-green-400'
                                    : 'bg-red-500/20 border border-red-500/30 text-red-400'
                                }`}>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-white/10">
                            ...
                            <span className="text-sm text-white/80">{metrics.lastIndexed}</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-lg font-semibold text-white">Multi-Modal Performance</h3>
                </div>
