...
export default function JurisCaseCard({ caseData, onClick }: JurisCaseCardProps) {
    ...
    return (
        <div className="space-y-0">
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-900/20 to-violet-900/20 p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 backdrop-blur-sm">
                ...
                <div className="mb-4">
                    <div className="mb-2">
                        <span className="text-xs font-semibold text-purple-300 uppercase tracking-wide">Facts</span>
                        <p className="text-sm text-white/70 mt-1 line-clamp-2">{caseData.facts}</p>
                    </div>
                    <div>
                        <span className="text-xs font-semibold text-purple-300 uppercase tracking-wide">Holding</span>
                        <p className="text-sm text-white/70 mt-1 line-clamp-2">{caseData.holding}</p>
                    </div>
                </div>
