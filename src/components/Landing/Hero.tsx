  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-4 z-50 group">
        <div className="relative p-3 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10 shadow-lg hover:bg-white/10 hover:border-white/20 transition-all duration-300">
          {/* Glass glow effect */}
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-purple-500/20 via-blue-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-300" />
