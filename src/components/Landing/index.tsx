        ...
        <div
          ...
          style={
            isScrolled || isMobile
              ...
              : {
                  background:
                    "linear-gradient(to right, rgb(10,10,10) 0%, rgb(10,10,10) 50%, transparent 85%)",
        ...
        <div className="w-full max-w-[90%] md:max-w-screen-2xl mx-auto flex items-center justify-between pl-0 md:pl-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.color = "oklch(0.9 0 0 / 0.7)")
              }
              onMouseLeave={(e) =>
                (e.currentTarget.style.color = "oklch(0.9 0 0 / 0.5)")
              }
            >
              {t("nav.blog")}
            </button>
