        ...
        <div className="mb-20">
          <div className="rounded-2xl border border-blue-500/20 bg-gradient-to-br from-white/[0.02] via-white/[0.01] to-transparent backdrop-blur-sm p-8 md:p-12">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/30 flex items-center justify-center flex-shrink-0 p-2">
                <svg 
                ...
                >
                  <defs>
                    <linearGradient id="logoGradientAbout" x1="0%" y1="0%" x2="100%" y2="0%">
