  ...
  ({
    ...
    return (
      ...
      >
        {!isLowEnd && (
          <div
            className={`absolute inset-0 bg-gradient-to-br ${colorClass} via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100`}
          />
        )}
    ...
    <div className="relative py-24 px-4 sm:px-6 bg-transparent overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex justify-center mb-16">
          <div
            className={`p-1.5 rounded-full bg-white/5 border border-white/10 ${isLowEnd ? "" : "backdrop-blur-sm"} inline-flex relative`}
          >
            {/* Sliding Background */}
            <motion.div
