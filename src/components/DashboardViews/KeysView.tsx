        ...
        setKeys(
          result.keys.map((k: any) => ({
            ...
            lastUsed: k.last_used
              ? new Date(k.last_used).toLocaleDateString("en-US", {
                  month: "short",
                  day: "numeric",
                  year: "numeric",
                })
      ...
      >
        ...
        <div>
          ...
          <p
            className={cn(
              "text-sm mt-1",
              isDark ? "text-orange-400/70" : "text-orange-600/80",
            )}
          >
            {t("keys.secureDesc")}
          </p>
            ...
            {keys.map((key) => (
              ...
              >
                <div className="col-span-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      >
                        {t("keys.rateLimitPrefix")} {key.rateLimit}{" "}
                        {t("keys.rateLimitUnit")}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-span-3">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {showToken === key.id
                        ? key.token
                        : `${key.token.substr(0, 12)}...${key.token.substr(-4)}`}
                    </code>
                    <button
                      onClick={() =>
                        setShowToken(showToken === key.id ? null : key.id)
                      }
                      className={cn(
                        "p-1 rounded",
                        isDark
                ...
                <div className="col-span-2">
                  ...
                  >
                    {t("keys.lastUsedPrefix")} {key.lastUsed}
                  </p>
                </div>
            ...
            >
              <div>
                ...
                {wizardStep !== "created" && (
                  ...
                  >
                    {t("keys.stepOf").replace(
                      "{step}",
                      getStepNumber().toString(),
                    )}
                  </p>
                )}
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {newKeyRateLimit} {t("keys.rateLimitUnit")}
                      </span>
                      <span
                        className={cn(
                          "text-xs",
