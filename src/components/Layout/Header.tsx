...
export default function Header({ onMobileMenuClick, isStatic = false }: HeaderProps) {
    ...
    <>
      <header className={cn(
        ...
        <div className="flex items-center justify-between w-full relative z-10">
          ...
          <div className="md:hidden">
            <button
              ...
              className={cn(
                ...
                "text-white" // Always white for contrast
              )}
            >
          ...
          {/* Desktop: Logo */}
          <div className="hidden md:flex items-center space-x-3"> {/* Increased spacing */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 464 468"
              className="w-14 h-14 -ml-1" // Gigantic Logo Size
            ...
            <span className={cn(
              "text-3xl font-bold tracking-tight", // Larger text to match gigantic logo
