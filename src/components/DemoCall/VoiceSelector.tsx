    ...
    >
      ...
      >
        <div className="flex items-center gap-2 mr-2">
          ...
          <span
            className={cn(
              "text-xs uppercase font-bold tracking-wider opacity-50",
            )}
          >
            Filters
          </span>
        ...
        <div
          className={cn("w-px h-6", isDark ? "bg-white/10" : "bg-black/10")}
        />
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs opacity-60 line-clamp-1 mb-2.5">
                        {voice.description}
                      </p>
