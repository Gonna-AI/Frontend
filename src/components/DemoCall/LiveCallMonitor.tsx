    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            <Activity
              className={cn("w-4 h-4", isDark ? "text-white" : "text-black")}
            />
          </div>
          <div>
            <h3
      ...
      {isActive && currentCall?.category && (
        <div
          className={cn(
            ...
            isDark
              ? "border-white/10 bg-purple-500/5 text-purple-200"
              : "border-black/5 bg-purple-50 text-purple-700",
          )}
        >
