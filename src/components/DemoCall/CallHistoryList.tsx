...
export default function CallHistoryList({
  ...
  const filteredHistory = callHistory.filter((call) => {
    if (filterPriority !== "all" && call.priority !== filterPriority)
      return false;
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute(
      "download",
      `clerktree_history_${new Date().toISOString().split("T")[0]}.csv`,
    );
          ...
          <button
            ...
            className={cn(
              ...
              isDark
                ...
                : "border-black/10 hover:bg-gray-50 text-gray-700",
            )}
          >
                      ...
                      {expandedId === item.id && (
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              className="flex gap-2 mb-6 p-1 rounded-lg border w-fit mx-auto md:mx-0 backdrop-blur-sm relative z-10"
                              style={{
                                borderColor: isDark
                            ...
                            >
                              {(
                                ["summary", "transcript", "details"] as const
                              ).map((tab) => (
                                <button
                                  key={tab}
                            ...
                            {activeTab === "summary" && (
                              <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-top-2 duration-300">
                                ...
                                <div>
                                  <h4
                                    className={cn(
                                      "text-xs uppercase mb-2 font-semibold tracking-wider flex items-center gap-2",
                                      isDark
                                        ? "text-white/40"
                                        : "text-black/40",
                                    )}
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mb-6">
                                  {/* Key Points - Restored */}
                                  {item.summary.mainPoints &&
                                    item.summary.mainPoints.length > 0 && (
                                      <div>
                                        <h4
                                          className={cn(
                                            "text-xs uppercase mb-2 font-semibold tracking-wider flex items-center gap-2",
                                        ...
                                        >
                                          <ListTodo className="w-3 h-3" /> Key
                                          Points
                                        </h4>
                                        <div
                                          className={cn(
                                        ...
                                        >
                                          <ul
                                            className={cn(
                                              "space-y-3 text-sm relative z-10",
                                              isDark
                                                ? "text-white/70"
                                                : "text-gray-600",
                                            )}
                                          >
                                            {item.summary.mainPoints.map(
                                              (point, i) => (
                                                <li
                                                  key={i}
                                  ...
                                  <div>
                                    ...
                                    >
                                      ...
                                      <div className="relative z-10 space-y-4">
                                        ...
                                        <div
                                          className={cn(
                                            "flex items-start gap-3 text-sm min-w-0",
                                            isDark
                                              ? "text-white/70"
                                              : "text-gray-600",
                                          )}
                                        >
                                          ...
                                          <p className="flex-1 break-words">
                                            Consider offering a follow-up
                                            consultation to address the client's
                                        ...
                                        >
                                          ...
                                          <p className="flex-1 break-words">
                                            Update the user's profile with the
                                  ...
                                  >
                                    <div
                                      className={cn(
                                        ...
                                        item.summary.sentiment.includes(
                                          "positive",
                                        )
                                          ? "bg-emerald-500/20"
                                          : item.summary.sentiment.includes(
                                    ...
                                    <div className="relative z-10">
                                      ...
                                      <div className="flex items-center justify-between">
                                        ...
                                        >
                                          {item.summary.sentiment.replace(
                                            "_",
                                            " ",
                                          )}
                                        </span>
                                          ...
                                          <span
                                            ...
                                            className={cn(
                                              ...
                                              isDark
                                                ...
                                                : "bg-gray-50 border-black/5 text-gray-600",
                                            )}
                                          >
                                            {topic}
                                          </span>
                            ...
                            {activeTab === "transcript" && (
                              <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar animate-in fade-in slide-in-from-top-2 duration-300">
                                {item.messages.length === 0 ? (
                                  <p className="opacity-40 italic text-sm text-center py-8">
                              ...
                              <div className="space-y-8 animate-in fade-in slide-in-from-top-2 duration-300">
                                ...
                                <div>
                                  ...
                                  {item.extractedFields.length > 0 ? (
                                        ...
                                        >
                                          {item.extractedFields.map((field) => (
                                            ...
                                            >
                                              ...
                                              <td
                                                className={cn(
                                                  "px-4 py-3 text-right font-mono text-xs opacity-50",
                                                  isDark
                                                    ? "text-white"
                                                    : "text-black",
                                                )}
                                    ...
                                    <div
                                      className={cn(
                                        "p-8 text-center border rounded-lg border-dashed",
                                        isDark
                                    ...
                                    >
                                      <p className="text-sm italic">
                                        No data fields were extracted from this
                                        conversation.
                                      </p>
                                    </div>
                                  )}
                                ...
                                <div
                                  className={cn(
                                    "pt-6 border-t grid grid-cols-2 md:grid-cols-4 gap-6",
                                    isDark
                                      ? "border-white/5"
                                      : "border-black/5",
                                  )}
                                >
                                  <div>
                                    <span
                                      className={cn(
                                        "text-xs uppercase font-semibold tracking-wider block mb-1",
                                  ...
                                  <div>
                                    ...
                                    <span
                                      className={cn(
                                        "font-mono text-xs block truncate opacity-60",
                                        isDark ? "text-white" : "text-black",
                                      )}
                                    >
                                      {item.id}
