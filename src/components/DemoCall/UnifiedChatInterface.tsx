...
export default function UnifiedChatInterface({
  ...
  const [messageReasonings, setMessageReasonings] = useState<
    Map<number, { reasoning: string; thinkingTime: number }>
  >(new Map());
  const [expandedReasonings, setExpandedReasonings] = useState<Set<number>>(
    new Set(),
  );
  ...
  const handleSendMessage = useCallback(
    async (text: string, fromVoice = false) => {
      ...
      try {
        ...
        const thinkingTime = processingStartTime
  ...
  return (
    <div
      className={cn(
        ...
        isDark ? "bg-transparent" : "bg-white/50 backdrop-blur-sm",
      )}
    >
      {/* Messages Area */}
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                    ...
                    {!isUser && reasoning && (
                      ...
                      >
                        ...
                        >
                          ...
                          <span>
                            {t("chat.thought").replace(
                              "{time}",
                              reasoning.thinkingTime.toString(),
                            )}
                          </span>
                          {isExpanded ? (
                            ...
                            >
                              <div
                                className={cn(
                                  ...
                                  isDark
                                    ? "text-purple-200/70 border-purple-500/20"
                                    : "text-purple-700/70 border-purple-200/50",
                                )}
                              >
                                {reasoning.reasoning}
                              </div>
        ...
        {currentTranscript && isVoiceMode && (
          ...
          >
            ...
            >
              <p className="text-xs opacity-60 mb-1 uppercase tracking-wider font-semibold">
                {t("chat.listening")}
              </p>
      ...
      <div className={cn("p-4 md:p-6 pb-6 md:pb-8 flex justify-center")}>
          ...
          <form onSubmit={handleSubmit} className="flex items-center gap-2">
            ...
            {isActive && !isVoiceMode && messages.length > 0 && (
              ...
              >
                ...
                <span className="relative z-10 text-xs font-medium px-1">
                  {t("chat.end")}
                </span>
              </motion.button>
            )}
