...
export default function PriorityQueue({
  ...
  const priorities: {
    ...
    {
      level: "critical",
      label: t("dashboard.priority.critical"),
      shortLabel: t("dashboard.priority.critical"),
      color: "red",
      icon: AlertTriangle,
    },
    {
      ...
      shortLabel: t("dashboard.priority.highShort"),
      color: "orange",
      icon: TrendingUp,
    },
    {
      ...
      shortLabel: t("dashboard.priority.mediumShort"),
      color: "yellow",
      icon: Clock,
    },
    {
      ...
      shortLabel: t("dashboard.priority.lowShort"),
      color: "green",
      icon: CheckCircle,
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <BarChart3
          className={cn("w-5 h-5", isDark ? "text-white/60" : "text-black/60")}
        />
        <h3
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  {followUps > 0
                    ? `${followUps} ${t("dashboard.priority.needFollowUp")}`
                    : t("dashboard.priority.noPending")}
                </p>
              </div>
              <div
                className={cn(
