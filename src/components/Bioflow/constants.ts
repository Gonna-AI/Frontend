...
export const DOCTOR_LOGS: Record<string, string[]> = {
  ...
  "check-calendar": [
    ...
    "Found 3 available times",
  ],
  "check-patient": [
    "Looking up patient records",
    "Previous visit history found",
    "Patient verified",
  ],
  schedule: [
    "Selecting optimal time slot",
...
export const RESTAURANT_LOGS: Record<string, string[]> = {
  start: [
    ...
    "Party of 4 on Friday",
    "Request received",
  ],
  "check-tables": [
    "Checking available tables",
    "Filtering for 4+ seating",
    "2 outdoor options found",
  ],
  "check-vip": [
    "Checking loyalty status",
    "Gold member detected",
    "VIP perks unlocked",
  ],
  "check-special": [
    "Checking Friday specials",
    "Live Jazz Night confirmed",
    "Seafood special available",
  ],
  recommend: [
    "Analyzing all options",
    "Patio #3 is perfect for VIP",
    "Premium experience ready",
  ],
  confirm: [
    "Sending VIP confirmation",
    "Including special welcome",
    "Guest notified",
  ],
  "add-note": [
    "Alerting kitchen",
    "VIP treatment flagged",
    "Chef acknowledged",
  ],
};
...
export const LEGAL_LOGS: Record<string, string[]> = {
  ...
  "schedule-call": [
    ...
    "Call set for Thursday 2PM",
  ],
  "send-docs": [
    "Preparing documents",
    "Secure file sharing",
    "Client & lawyer notified",
  ],
};
