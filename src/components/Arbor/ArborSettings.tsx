...
export default function ArborSettings({
  mode,
  onModeChange,
  isInitialized,
  onInitialize,
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div>
        ...
        <div className="space-y-4">
          <div>
            <label className="text-xs sm:text-sm font-medium text-white/70 mb-2 sm:mb-3 block">
              Select Mode
            </label>
            <div className="grid grid-cols-1 gap-3 sm:gap-4">
              <button
                onClick={() => onModeChange("ask")}
                className={`p-4 sm:p-6 rounded-xl sm:rounded-2xl border-2 transition-all duration-300 text-left group ${
                  mode === "ask"
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center transition-all ${
                      mode === "ask"
                        ...
                        : "bg-white/10 text-white/50 group-hover:text-blue-400"
                    }`}
                  >
                  ...
                  <div className="flex-1">
                    <h3
                      className={`text-base sm:text-lg font-semibold mb-1 sm:mb-2 transition-colors ${
                        mode === "ask"
                          ? "text-blue-400"
                    ...
                    <p className="text-xs sm:text-sm text-white/60 leading-relaxed">
                      Ask questions about your documents, tasks, and calendar.
                      Get intelligent answers powered by RAG technology.
                    </p>
                  </div>
                </div>
                {mode === "ask" && (
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center transition-all ${
                      mode === "tell"
                        ...
                        : "bg-white/10 text-white/50 group-hover:text-purple-400"
                    }`}
                  >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white/60 leading-relaxed">
                      Execute autonomous tasks like generating reports, sending
                      emails, and managing your workflow.
                    </p>
                  </div>
                </div>
                {mode === "tell" && (
      ...
      <div className="p-4 sm:p-6 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 rounded-xl sm:rounded-2xl">
        ...
        <p className="text-white/70 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
          Arbor is your intelligent enterprise AI assistant that seamlessly
          integrates with Google Drive, Calendar, Sheets, and Gmail to provide
          advanced document search, task management, and workflow automation.
        </p>
        <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-white/60">
          <p>
            <strong className="text-emerald-400">✓</strong> Advanced RAG
            technology for Q&A
          </p>
          <p>
            <strong className="text-emerald-400">✓</strong> Hybrid search (65%
            keyword + 35% semantic)
          </p>
          <p>
            <strong className="text-emerald-400">✓</strong> Multilingual support
            (EN, DE, FR, ES)
          </p>
          <p>
            <strong className="text-emerald-400">✓</strong> 100% local
