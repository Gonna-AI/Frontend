        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <div className="space-y-4">
                    <div>
                        <label className="text-sm font-medium text-white/70 mb-3 block">Select Mode</label>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <button
                                onClick={() => onModeChange('ask')}
                                className={`p-6 rounded-2xl border-2 transition-all duration-300 text-left group ${mode === 'ask'
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${mode === 'ask' ? 'bg-blue-500/30 text-blue-400' : 'bg-white/10 text-white/50 group-hover:text-blue-400'
                                        }`}>
                                        <MessageSquare className="w-6 h-6" />
                                    </div>
                                    <div className="flex-1">
                                        <h3 className={`text-lg font-semibold mb-2 transition-colors ${mode === 'ask' ? 'text-blue-400' : 'text-white group-hover:text-blue-400'
                                            }`}>
                                            Ask Arbor
                                        </h3>
                                ...
                                {mode === 'ask' && (
                                    <div className="mt-4 px-3 py-1 bg-blue-500/20 border border-blue-500/30 rounded-full inline-block">
                            ...
                            <button
                                ...
                                className={`p-6 rounded-2xl border-2 transition-all duration-300 text-left group ${mode === 'tell'
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${mode === 'tell' ? 'bg-purple-500/30 text-purple-400' : 'bg-white/10 text-white/50 group-hover:text-purple-400'
                                        }`}>
                                        <Zap className="w-6 h-6" />
                                    </div>
                                    <div className="flex-1">
                                        <h3 className={`text-lg font-semibold mb-2 transition-colors ${mode === 'tell' ? 'text-purple-400' : 'text-white group-hover:text-purple-400'
                                            }`}>
                                            Tell Arbor
                                        </h3>
                                        <p className="text-sm text-white/60 leading-relaxed">
                                ...
                                {mode === 'tell' && (
                                    <div className="mt-4 px-3 py-1 bg-purple-500/20 border border-purple-500/30 rounded-full inline-block">
            ...
            <div>
                ...
                <div className="space-y-4">
                    <div>
                        <label className="text-sm font-medium text-white/70 mb-2 block">Document Repository</label>
                        <input
                            type="text"
                    ...
                    {!isInitialized && (
                        <button
                            ...
                            className="w-full px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/25"
                        >
                            Initialize System
                        </button>
                    )}
            ...
            <div className="p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl">
                ...
                <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-center justify-between py-2 border-b border-white/10">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${isInitialized
            ...
            <div className="p-6 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 rounded-2xl">
                <h3 className="text-lg font-semibold text-white mb-3">About Arbor</h3>
                ...
                <div className="space-y-2 text-sm text-white/60">
                    <p><strong className="text-emerald-400">✓</strong> Advanced RAG technology for Q&A</p>
                    <p><strong className="text-emerald-400">✓</strong> Hybrid search (65% keyword + 35% semantic)</p>
                    <p><strong className="text-emerald-400">✓</strong> Multilingual support (EN, DE, FR, ES)</p>
                    <p><strong className="text-emerald-400">✓</strong> 100% local processing for privacy</p>
                </div>
            </div>
        </div>
    );
