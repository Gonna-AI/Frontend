...
export const translations: Record<Language, Record<string, string>> = {
    ...
    de: {
        ...
        'about.team.katharina': 'Katharina Krüger (Assistentin der Geschäftsführung) bringt strategische Expertise aus ihren Positionen als Leiterin Strategie bei verschiedenen Unternehmen und bei Tchibo mit. Als Absolventin der Betriebswirtschaftslehre der Universität Mannheim optimiert sie nun die Geschäftsabläufe bei ClerkTree, treibt strategische Initiativen voran und sorgt für nahtlose organisatorische Effizienz.',
