...
export const MOCK_RESPONSES: Record<string, MockResponse> = {
  ...
  "I accidentally hit a pedestrian at night while driving home, what are the legal consequences?":
    {
      ...
      cases: [
        {
          ...
          facts:
            "Accused drove a BMW at high speed, hitting multiple pedestrians and fleeing the scene. The primary issue was the act of fleeing and destruction of evidence.",
          holding:
            "The Supreme Court upheld the conviction but modified the sentence to time served + community service + heavy fine, emphasizing that flight is a severe aggravating factor.",
        ...
        },
        {
          ...
          facts:
            "Alleged hit-and-run case involving a vehicle running over people sleeping on a pavement. Key issues involved evidence of driving and the chain of custody.",
          holding:
            "The High Court acquitted the accused due to lack of conclusive evidence establishing he was the driver, highlighting the burden of proof in criminal negligence.",
      ...
      analysis: {
        caseId: "n-1",
        similaritySummary:
          "Your query involves a hit-and-run scenario with potential fatalities. The Sanjeev Nanda case is 95% similar as it deals directly with the consequences of fleeing after a fatal accident.",
        keyLegalConcepts: [
  ...
  "My landlord is refusing to return my security deposit after I moved out, claiming damages I didn't cause.":
    {
      content:
        "Refusal to return security deposit for 'normal wear and tear' is a common dispute. Under the Model Tenancy Act and Consumer Protection laws, landlords cannot deduct for reasonable wear. You can approach the Rent Authority or Consumer Forum. The cases below show successful recovery of deposits with interest.",
      cases: [
        {
          id: "n-3",
          ...
          facts:
            "Tenant vacated premises; landlord withheld deposit citing painting and cleaning charges. Tenant argued these were normal wear and tear.",
          holding:
            "Commission ruled that painting and routine cleaning fall under normal wear and tear. Landlord ordered to refund deposit with 9% interest.",
        ...
        },
        {
          ...
          facts:
            "Dispute over security deposit refund. Landlord claimed damages for broken fixtures which tenant proved were pre-existing.",
          holding:
            "Court held that without joint inspection report at move-in, landlord cannot arbitrarily claim damages. Deposit must be refunded.",
          precedents: [],
          metadata: {
            court_type: "High Court",
            ...
            parties: {
              petitioner: "Col. T.S. Grewal",
              respondent: "Deepanjan Dutta",
            },
      ...
      analysis: {
        caseId: "n-3",
        similaritySummary:
          "The query matches disputes regarding security deposit deductions. Vikas Singh v. DLF is highly relevant (92%) as it establishes that normal wear and tear cannot be deducted.",
        keyLegalConcepts: [
          "Security Deposit",
  ...
  "I bought a defective laptop online and the seller refuses to refund or replace it.":
    {
      content:
        "E-commerce platforms and sellers are liable for defective goods under the Consumer Protection Act, 2019. 'No refund' policies for defective items are void. You are entitled to a replacement or refund. See these precedents where consumers were awarded compensation.",
      cases: [
        {
          id: "n-5",
          ...
          facts:
            "Purchaser bought a vehicle with manufacturing defects. Dealer refused replacement. Issue was whether replacement is mandatory for defects.",
          holding:
            "Supreme Court held that if a manufacturing defect is established, the consumer is entitled to replacement or full refund, plus compensation for harassment.",
          ...
          metadata: {
            ...
            parties: {
              petitioner: "C.N. Anantharam",
              respondent: "Fiat India",
            },
        ...
        },
        {
          ...
          facts:
            "Defective laptop sold online. Seller claimed warranty only covers repair, not replacement. Laptop failed repeatedly.",
          holding:
            "Commission ruled that selling a lemon product constitutes unfair trade practice. Ordered full refund with 12% interest and compensation.",
          precedents: [],
          metadata: {
      ...
      analysis: {
        caseId: "n-5",
        similaritySummary:
          "Matches consumer disputes regarding defective goods and refusal to refund. Anantharam case is a landmark judgment (91%) affirming right to replacement.",
        keyLegalConcepts: [
          "Deficiency in Service",
  ...
  "I am representing a client accused in a dowry death case under Section 304B. I need a comprehensive analysis of recent Supreme Court judgments regarding the presumption of guilt and rebuttal standards, specifically focusing on the 'soon before death' interpretation.":
    {
      ...
      cases: [
        {
          ...
          facts:
            'Appeal against conviction under 304B. The core issue was the interpretation of "soon before death" and whether the prosecution had established the link.',
          holding:
            'SC clarified that "soon before death" must be interpreted flexibly to mean a "proximate live link". Section 304B is a strict liability provision once ingredients are met.',
          precedents: [
        ...
        },
        {
          ...
          facts:
            "Landmark case defining the temporal element of dowry death. Prosecution relied on circumstantial evidence of cruelty.",
          holding:
            'Held that "soon before" is not synonymous with "immediately before". It depends on the facts and impact of cruelty on the victim\'s mind.',
          precedents: [],
          metadata: {
            court_type: "Supreme Court",
            jurisdiction: "Criminal Law",
      ...
      analysis: {
        caseId: "d-1",
        similaritySummary:
          'The query specifically targets the "soon before death" interpretation in 304B cases. Satbir Singh (2021) is the most recent and authoritative ruling (98% match) on this exact issue.',
        keyLegalConcepts: [
          "Dowry Death",
  ...
  "Analyze the constitutional validity of the latest IT Rules amendment regarding intermediary liability, focusing on freedom of speech implications under Article 19(1)(a) and recent High Court precedents on safe harbor provisions.":
    {
      ...
      cases: [
        {
          ...
          facts:
            'Challenge to Section 66A of IT Act. Relevant for its discussion on intermediary liability and the "chilling effect" on free speech.',
          holding:
            "Section 66A struck down as unconstitutional. Intermediaries are only bound to act upon court orders or government directives, not private complaints.",
        ...
        },
        {
          ...
          facts:
            "Challenge to the 2023 IT Rules Amendment establishing a government Fact Check Unit (FCU). Petitioner argued it violates Article 19(1)(a).",
          holding:
            "Split verdict delivered. Matter referred to third judge. Interim stay on the operation of the FCU continues.",
      ...
      analysis: {
        caseId: "d-3",
        similaritySummary:
          "Shreya Singhal is the bedrock precedent (96%) for any discussion on online free speech and intermediary liability, directly addressing Article 19(1)(a) limits.",
        keyLegalConcepts: [
  ...
  "Prepare a detailed legal strategy for a corporate insolvency resolution process where the operational creditor's claim is disputed. Cite relevant NCLT and NCLAT rulings on 'pre-existing dispute' under the IBC code.":
    {
      content:
        "For a Corporate Insolvency Resolution Process (CIRP) under Section 9 of the IBC, the existence of a 'pre-existing dispute' is a complete defense. If the Corporate Debtor can show a plausible dispute raised before the demand notice, the application must be rejected. \n\nStrategy:\n1. Collate all correspondence showing dispute prior to Section 8 notice.\n2. Rely on Mobilox Innovations judgment.\n3. Demonstrate that the dispute is not spurious or hypothetical.",
      cases: [
        {
          id: "d-5",
          ...
          facts:
            "Operational Creditor filed for CIRP. Debtor claimed a pre-existing dispute regarding quality of service. NCLAT allowed CIRP; SC set it aside.",
          holding:
            'SC held that if a "plausible contention" of a pre-existing dispute exists, the Adjudicating Authority must reject the Section 9 application. It need not decide the merits of the dispute.',
          precedents: [],
          metadata: {
            court_type: "Supreme Court",
            ...
            parties: {
              petitioner: "Mobilox Innovations",
              respondent: "Kirusa Software",
            },
        ...
        },
        {
          ...
          similarityScore: 0.9,
          facts:
            "Constitutional validity of IBC challenged. Addressed the distinction between Financial and Operational Creditors.",
          holding:
            'Upheld the constitutionality of IBC. Clarified the rationale for treating Operational Creditors differently, emphasizing the "pre-existing dispute" safeguard.',
      ...
      analysis: {
        caseId: "d-5",
        similaritySummary:
          'Mobilox Innovations is the definitive authority (99%) on "pre-existing disputes" under Section 9 IBC. It perfectly matches the strategy requirement for defending against an Operational Creditor.',
        keyLegalConcepts: [
