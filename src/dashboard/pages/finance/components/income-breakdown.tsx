    ...
    <Card>
      ...
      <CardContent className="grid grid-cols-1 gap-1 md:grid-cols-3">
        <section className="isolate flex gap-[0.5px]">
          ...
          <div className="flex min-h-24 flex-1 flex-col justify-between">
            <div className="flex min-w-0 flex-col gap-1 px-1">
              <p className="wrap-break-word text-muted-foreground text-xs leading-none">High severity · 3 of 5</p>
              <div className="text-lg leading-none tracking-tight">-€900</div>
            </div>
        ...
        <section className="isolate flex gap-[0.5px]">
          ...
          <div className="flex min-h-24 flex-1 flex-col justify-between">
            <div className="flex min-w-0 flex-col gap-1 px-1">
              <p className="wrap-break-word text-muted-foreground text-xs leading-none">Medium severity · 2 of 5</p>
              <div className="text-lg leading-none tracking-tight">+€1,250</div>
            </div>
        ...
        <section className="isolate flex gap-[0.5px]">
          ...
          <div className="flex min-h-24 flex-1 flex-col justify-between">
            <div className="flex min-w-0 flex-col gap-1 px-1">
              <p className="wrap-break-word text-muted-foreground text-xs leading-none">Removed line item · 1 of 5</p>
              <div className="text-lg leading-none tracking-tight">-€2,100</div>
            </div>
