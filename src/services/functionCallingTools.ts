...
export const conversationTools: FunctionTool[] = [
  {
    ...
    function: {
      ...
      description:
        "Extract caller information from the conversation including name, contact details, and any identifying information",
      parameters: {
        type: "object",
        properties: {
          caller_name: {
            type: "string",
            description:
              "Full name of the caller (first name and optionally last name)",
          },
          contact_phone: {
            type: "string",
          ...
          caller_role: {
            type: "string",
            description:
              "Role or job title if mentioned (e.g., manager, patient, customer)",
          },
          reference_number: {
            type: "string",
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Assess the seriousness and urgency level of the conversation based on keywords, tone, and context",
      parameters: {
        type: "object",
        properties: {
          priority_level: {
          ...
          urgency_indicators: {
            type: "array",
            description:
              "List of phrases or indicators that suggest the urgency level",
            items: { type: "string" },
          },
          reasoning: {
            type: "string",
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Analyze the emotional sentiment and tone of the conversation",
      parameters: {
        type: "object",
        properties: {
          overall_sentiment: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Identify the main topics and issues discussed in the conversation",
      parameters: {
        type: "object",
        properties: {
          primary_topic: {
      ...
      parameters: {
        ...
        properties: {
          ...
          detailed_summary: {
            type: "string",
            description:
              "A detailed summary including all key points discussed",
          },
          main_points: {
            type: "array",
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Extract specific requirements, requests, or needs expressed by the caller",
      parameters: {
        type: "object",
        properties: {
          explicit_requests: {
          ...
          constraints: {
            type: "array",
            description:
              "Limitations or constraints mentioned (time, budget, etc.)",
            items: { type: "string" },
          },
          deadline: {
            type: "string",
 ...
 */
export function mapToExtractedFields(
...
export function getSuggestedCategory(
  ...
  return categories.find(
    (c) =>
      ...
      c.name
        .toLowerCase()
        .includes(analysis.issueTopics!.issue_category.toLowerCase()),
  );
}
...
export function generateFunctionCallingSystemPrompt(
  ...
  if (
    missingContactInfo &&
    !missingContactInfo.hasPhone &&
    !missingContactInfo.hasEmail
  ) {
    contactInstruction = `
