                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                  ...
                  <motion.button
                    ...
                    onClick={async () => {
                      ...
                      if (
                        ...
                        console.log(
                          "🔄 Ending active voice call before starting chat session...",
                        );
                        await endCall();
                      }
                      setMode("chat");
                  ...
                  <motion.button
                    ...
                    onClick={async () => {
                      ...
                      if (
                        currentCall?.status === "active" &&
                        currentCall?.type === "text"
                      ) {
                        console.log(
                          "🔄 Ending active text session before starting voice call...",
                        );
                        await endCall();
                      }
                      setMode("call");
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      >
                        Speak directly with our AI agent. Natural, hands-free
