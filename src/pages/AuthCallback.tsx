        ...
        const handleCallback = async () => {
            try {
                ...
                if (errorParam) {
                    ...
                    navigate(`/login?message=${encodeURIComponent(errorDescription || 'Authentication failed')}`, { replace: true });
                    return;
                }
                ...
                if (session) {
                    ...
                    navigate('/login?view=signin&message=Please sign in to continue', { replace: true });
                }
            } catch (err) {
