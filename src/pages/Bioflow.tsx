  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-indigo-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-purple-500/10 rounded-full blur-3xl" />
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <Link
                to="/"
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 flex items-center justify-center shrink-0 hover:border-indigo-500/50 transition-all hover:scale-105"
              >
                <svg
                  viewBox="0 0 464 468"
      ...
      {/* Info Banner */}
      <div className="relative border-b border-white/5 bg-indigo-500/5">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-slate-400">
                ...
                {t("bioflow.instruction")}{" "}
                <span className="font-medium text-indigo-400">
                  {t("bioflow.runWorkflow")}
                </span>{" "}
                {t("bioflow.inAction")}
              </p>
            </div>
            <p className="text-xs text-slate-500">{t("bioflow.controls")}</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative" style={{ height: "calc(100vh - 140px)" }}>
        <div className="max-w-[1920px] mx-auto h-full px-4 sm:px-6 py-4">
          <WorkflowEditor initialUseCase="doctor" />
        </div>
      </div>
    </div>
  );
