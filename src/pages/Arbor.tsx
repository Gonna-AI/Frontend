    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 w-full py-3 px-4 sm:px-6 backdrop-blur-md bg-[rgb(10,10,10)]/80 border-b border-white/10">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="h-6 md:h-8 w-px bg-white/10 ml-2" />
                        <h1 className="ml-2 text-lg md:text-xl font-bold bg-gradient-to-r from-emerald-400 via-teal-400 to-emerald-600 text-transparent bg-clip-text">
                            Arbor
                        </h1>
                    </div>

                    {/* Settings Icon - No Container */}
                    <button
                        onClick={() => setShowDashboard(!showDashboard)}
                        className={`p-2 text-white/80 hover:text-white transition-colors ${showDashboard ? 'text-emerald-400' : ''
                            }`}
            ...
            <div className="relative pt-[70px]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 pb-[180px] sm:pb-[200px]">
                    {showDashboard ? (
                        <ArborDashboard
                            stats={stats}
