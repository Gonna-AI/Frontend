...
export default function AuthPage() {
  const { session, loading, signIn, signUp, signInWithGoogle, resetPassword } =
    useAuth();
      ...
      if (view === "signup") {
        ...
        if (error) {
          if (error.message.includes("Email not confirmed")) {
            ...
            setError(
              "Network error connecting to authentication server. Please try clearing your browser cache and cookies, then try again.",
            );
          } else {
            setError(error.message);
          }
    ...
    return (
      ...
      >
        <motion.div
          ...
          className={cn(
            "w-full max-w-md p-8 rounded-2xl shadow-xl text-center border",
            isDark
  ...
  return (
    <div
      className={cn(
        "min-h-screen w-full flex transition-colors duration-500",
        isDark ? "bg-[#09090B]" : "bg-gray-50",
      )}
    >
      {/* Theme Toggle */}
      ...
      <div className="flex w-full max-w-[500px] mx-auto min-h-screen lg:p-4 items-center justify-center">
        ...
        <motion.div
          ...
          className={cn(
            "w-full overflow-hidden rounded-[32px] border shadow-2xl transition-all duration-500",
            isDark
              ...
              >
                {view === "signup"
                  ...
                  : view === "forgot_password"
                    ...
                    : "Login to your ClerkTree account."}
              </p>
            </div>
              ...
              <>
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span
                      className={cn(
                        "px-2 font-medium tracking-wider",
                        isDark
                          ? "bg-[#121214] text-zinc-500"
                ...
                <div className="mt-8 text-center text-sm">
                  <span
                    className={cn(isDark ? "text-zinc-500" : "text-gray-500")}
                  >
                    {view === "signup"
