...
export default function Careers() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${supabaseUrl}/functions/v1/api-careers`, {
        method: "POST",
        body,
    ...
    <div className="bg-[rgb(10,10,10)] min-h-screen relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 bg-[rgb(10,10,10)] -z-10">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(16,185,129,0.6) 0%, rgba(16,185,129,0.25) 40%, transparent 100%)",
            filter: "blur(80px)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(5,150,105,0.5) 0%, rgba(5,150,105,0.2) 40%, transparent 100%)",
            filter: "blur(80px)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 py-12 px-6 pt-32 md:pt-36">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-6 mb-12">
            ...
            <span className="text-white/40 text-base font-medium tracking-wider">
              {t("careers.or")}
            </span>
            <div className="h-px bg-gradient-to-r from-transparent via-white/20 to-transparent flex-1 max-w-xs"></div>
          </div>
          ...
          <div className="rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-white/[0.02] via-white/[0.01] to-transparent backdrop-blur-sm p-8 md:p-12">
            ...
            <p className="text-white/60 mb-8">{t("careers.formDesc")}</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="0-1" className="bg-gray-900">
                        0-1 {t("careers.years") || "years"}
                      </option>
                      <option value="1-3" className="bg-gray-900">
                        1-3 {t("careers.years") || "years"}
                      </option>
                      <option value="3-5" className="bg-gray-900">
                        3-5 {t("careers.years") || "years"}
                      </option>
                      <option value="5-10" className="bg-gray-900">
                        5-10 {t("careers.years") || "years"}
                      </option>
                      <option value="10+" className="bg-gray-900">
                        10+ {t("careers.years") || "years"}
                      </option>
                    </select>
                  </div>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="senior-frontend" className="bg-gray-900">
                      {t("careers.pos1")}
                    </option>
                    <option value="fullstack" className="bg-gray-900">
                      {t("careers.pos2")}
                    </option>
                    <option value="product-designer" className="bg-gray-900">
                      {t("careers.pos3")}
                    </option>
