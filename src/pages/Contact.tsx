    ...
    <div className="bg-[rgb(10,10,10)] min-h-screen relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 bg-[rgb(10,10,10)] -z-10">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(239,68,68,0.6) 0%, rgba(239,68,68,0.25) 40%, transparent 100%)",
            filter: "blur(80px)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(185,28,28,0.5) 0%, rgba(185,28,28,0.2) 40%, transparent 100%)",
            filter: "blur(80px)",
          }}
        />
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16 max-w-5xl mx-auto">
            <div className="group rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-xl p-6 hover:border-red-500/30 hover:bg-white/[0.04] transition-all duration-300 text-center">
              ...
              <h3 className="font-semibold mb-2 text-white/90 text-lg">
                {t("contact.phone")}
              </h3>
              <a
                href="tel:+4917683075116"
                className="text-white/60 hover:text-red-400 transition-colors text-sm block"
              >
                +49 176 83075116
              </a>
            </div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="enterprise" className="bg-neutral-900">
                          {t("contact.intEnterprise")}
                        </option>
                        <option value="bulk" className="bg-neutral-900">
                          {t("contact.intBulk")}
                        </option>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="1-10" className="bg-neutral-900">
                          1-10
                        </option>
                        <option value="11-50" className="bg-neutral-900">
                          11-50
                        </option>
                        <option value="51-200" className="bg-neutral-900">
                          51-200
                        </option>
                        <option value="201+" className="bg-neutral-900">
                          201+
                        </option>
                      </select>
                      <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-white/30">
