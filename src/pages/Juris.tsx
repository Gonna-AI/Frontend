...
const SAMPLE_CASES: CaseResult[] = [
  {
    ...
    facts:
      "The case involved the validity of the Punjab Security of Land Tenures Act, 1953, which imposed restrictions on the right of landowners to transfer their land.",
    holding:
      "The Court held that the Act was valid and constitutional, as it was enacted to give effect to Article 31A of the Constitution.",
  ...
  },
  {
    ...
    facts:
      "Challenge to the constitutional amendments limiting fundamental rights, particularly regarding property rights and religious freedom.",
    holding:
      'The Court propounded the "Basic Structure Doctrine" - Parliament cannot alter the basic structure of the Constitution even through amendments.',
    precedents: [
  ...
  const showResults = (query: string) => {
    ...
    setTimeout(() => {
      ...
      let analysis = {
        ...
        similaritySummary:
          "The query matches cases involving constitutional validity of land tenure legislation and fundamental rights. The legal reasoning patterns show 94% semantic similarity.",
        keyLegalConcepts: [
          "Constitutional Law",
          "Property Rights",
          "Article 31A",
      ...
      if (mockResponse) {
        ...
        if (isDeep) {
          content = t("juris.simulatedDeep").replace(
            "{count}",
            results.length.toString(),
          );
        } else {
          content = t("juris.simulatedNormal").replace(
            "{count}",
            results.length.toString(),
          );
        }
          ...
          <div className="flex items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              >
                <svg
                  viewBox="0 0 464 468"
                  className="w-6 h-6 sm:w-8 sm:h-8 -translate-y-0.5"
                >
                  <path
                    fill="white"
