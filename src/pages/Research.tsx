...
function ResearchLanding({ topic, isResearchHost }: { topic: ResearchTopic; isResearchHost: boolean }) {
  ...
  return (
    <>
      <SEO
        title={language === 'de' ? 'Forschung' : 'Research'}
        description={
          language === 'de'
            ? 'ClerkTree-Forschung zu Agentensystemen, Benchmark-Einreichungen und anwendungsnahen Reasoning-Workflows.'
            : 'ClerkTree research on agent systems, benchmark submissions, and applied reasoning workflows.'
        }
        canonical={getResearchCanonical()}
        openGraph={{
          title: language === 'de' ? 'ClerkTree Forschung' : 'ClerkTree Research',
          description:
            language === 'de'
              ? 'Forschungsupdates von ClerkTree und die öffentliche Arbeit dahinter.'
              : 'Research updates from ClerkTree and the public work behind them.',
  ...
  return (
    <>
      <SEO
        ...
        description={topic.summary[language]}
