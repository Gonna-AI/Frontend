...
function ResearchShell({ children }: { children: ReactNode }) {
  return (
    <div className="agero-works min-h-screen overflow-x-hidden bg-[#f4f1eb] text-[#151515]">
      <div className="agero-top-area agero-top-area-compact"><Header /></div>
...
function ResearchLanding({ isResearchHost }: { isResearchHost: boolean }) {
  ...
  return (
    <>
      ...
      <ResearchShell>
        <section className="relative overflow-hidden bg-[#141414] px-6 pb-20 pt-20 text-[#f4f1eb] md:px-12 md:pb-28 md:pt-28">
        ...
        <section className="px-6 py-20 md:px-12 md:py-28">
          <div className="mx-auto max-w-[1440px]">
            ...
            <button type="button" onClick={() => navigate(projectPath(featured.slug, isResearchHost))} className="group grid w-full gap-10 rounded-[2rem] bg-white p-7 text-left shadow-[0_20px_60px_rgba(24,20,16,.08)] transition-transform duration-500 hover:-translate-y-1 md:p-12 lg:grid-cols-[.85fr_1.15fr]">
