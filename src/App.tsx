...
const Security = lazyWithRetry(
  () => import("./components/Legal/Security"),
  "Security",
);
...
const SmartContracts = lazyWithRetry(
  () => import("./pages/SmartContracts"),
  "SmartContracts",
);
...
const DemoDashboard = lazyWithRetry(
  () => import("./pages/DemoDashboard"),
  "DemoDashboard",
);
const UserCall = lazyWithRetry(() => import("./pages/UserCall"), "UserCall");
const UserChat = lazyWithRetry(() => import("./pages/UserChat"), "UserChat");
const UserVoiceCall = lazyWithRetry(
  () => import("./pages/UserVoiceCall"),
  "UserVoiceCall",
);
...
const WhitePaper = lazyWithRetry(
